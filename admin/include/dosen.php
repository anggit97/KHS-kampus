        ...
        <a href="index.php?page=16" class="btn btn-primary btn-lg" style="margin-right:10px;float:right;"><i class="fa fa-plus"></i> Tambah Dosen</a>

		<h5><b>Daftar Dosen</b></h5>
		<p>Berikut ini adalah daftar dosen yang terdaftar di database universitas : 
		</p>
		<br>
        ...
        <table id="dosen" class="row-border" cellspacing="0" width="100%">
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $rows['alamat_dosen']; ?></td>
                        <td><?php echo $rows['email']; ?></td>
                        <td><a href="index.php?page=17&&nid=<?php echo $rows['nid']; ?>" class="btn btn-success btn-sm">&nbsp;UBAH&nbsp;&nbsp;</a>  <a class="btn btn-danger btn-sm" href="#" data-toggle="modal" data-target="#confirm-delete_<?php echo $rows['nid']; ?>">HAPUS</a></td>
                    </tr>
