...
?>
          <h1>
            <b>Pilih Dosen Pengajar</b>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#"><i class="fa fa-user"></i> Pilih Dosen Pengajar</a></li>
          </ol>
    ...
    <h5><b>Pilih Dosen Pengajar</b></h5>
                  ...
                  <form action="" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <select name="dosen" id="dosen" class="form-control">
                        ...
                        ?>
                        <option value="<?php echo $rowss['nid']; ?>"><?php echo $rowss['nid']; ?> - <?php echo $rowss['nama_dosen']; ?></option>
                        <?php
                          }
                        }
                        ?>
...
<?php 
  ...
  if (isset($_POST['simpan'])) {
    ...
    if ($dosen == "") {
      ...
      echo "<script>window.location = 'index.php?page=8&&kd_matkul=$kd_matkul'</script>";
    }else{
      $query = mysqli_query($conn,"INSERT INTO ujian (kode_matkul,nid)VALUES('$kd_matkul','$dosen')");
      if ($query) {
