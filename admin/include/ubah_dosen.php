                ...
                <div class="box-body">
                  <form action="" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama Dosen" value="<?php echo $rows['nama_dosen']; ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="alamat" id="alamat" class="form-control" cols="30" rows="3" placeholder="Alamat"><?php echo $rows['alamat_dosen']; ?></textarea>
                    </div>
...
<?php 
  ...
  if (isset($_POST['simpan'])) {
    ...
    if ($nid == "" || $nama == "" || $jk == "" || $alamat == "" || $email == "") {
      $_SESSION['pesan'] = "<div class='alert alert-danger' style='margin-top:5px;'>
                                <a href='#'' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
                                Tidak Boleh Ada Field yang Kosong!
                              </div>";
      echo "<script>window.location = 'index.php?page=17&&nid=$nid'</script>";
    }else{
      $query = mysqli_query($conn,"UPDATE dosen SET nama_dosen='$nama',jk='$jk',alamat_dosen='$alamat',email='$email' WHERE nid='$nid'");
      if ($query) {
