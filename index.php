...
if (isset($_POST['login'])) {
	...
	$query = mysqli_query($conn, "SELECT password from mahasiswa where nim='$nim'");
	...
	<div class="container">
		...
		<div class="row log">
		    <div class="col s7 offset-s2 card-panel z-depth-3">
		      <center><h5>LOGIN Mahasiswa</h5></center>
		      ...
		      <form method="post" action="">
		        <div class="row">
		          <div class="input-field col s12">
		            ...
		            <input id="icon_prefix" type="text" class="validate" name="nim" placeholder="NIM">
		          </div>
		    ...
		    <div class="col s7 offset-s2 card-panel z-depth-3"><br>
		    	<div class="row">
		    		<div class="col s6">
		    		<a class="waves-effect waves-light btn red darken-1" href="dosen" style="margin-left:30px;"><i class="mdi mdi-forward left"></i>Login Dosen</a>
