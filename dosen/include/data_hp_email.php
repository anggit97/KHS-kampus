                ...
                <div class="box-body">
                  <form action="" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="nama" value="<?php echo $data['nama_dosen']; ?>" disabled>
                    </div>
                    <div class="form-group">
                      <span><b>Alamat : </b></span> 
                      <input type="text" class="form-control" name="alamat" value="<?php echo $data['alamat_dosen']; ?>">
                    </div>
                    <div class="form-group">
                      <span><b>Email :  </b></span> 
...
<?php 
  ...
  if (isset($_POST['simpan'])) {
    ...
    $sqli  = mysqli_query($conn,"UPDATE dosen set alamat_dosen='$alamat',email='$email' WHERE nid='$nid'");
    if ($sqli) {
